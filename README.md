...
<body>
    <div class="jumbotron jumbotron-fluid" style="background-color:#FF1EFA;">
...
```
### HOUSE MODEL PREDICTION .VIEWS.PY:
...
## RESULT:
    Thus a website is designed for the chip manufacturing company and is hosted in thr URL http://priyadarshini.student.saveetha.in:8000/HouseModelTraining/.HTML code is validate.

    Thus a website is designed for the chip manufacturing company and is hosted in thr URL http://priyadarshini.student.saveetha.in:8000/HouseModelPrediction/.HTML code is validate.
